...
Event(50000, Default, function() { //Event ID, Restart Type, Event Parameters 
    IfCharacterHasSpeffect(AND_01, 10000, 2101, true, ComparisonType.Equal, 1);
    IfCharacterHasSpeffect(AND_01, 10000, 112061000, true, ComparisonType.Equal, 1); 
    
    IfConditionGroup(MAIN, PASS, AND_01); //If AND_01 is TRUE, continue. If not, keep checking all conditions.
    SetSpEffect(10000, 1062300);
    
    IfCharacterHasSpeffect(OR_01, 10000, 2101, false, ComparisonType.Equal, 1);
    IfCharacterHasSpeffect(OR_01, 10000, 112061000, false, ComparisonType.Equal, 1);
    
    IfConditionGroup(MAIN, PASS, OR_01);
    ClearSpeffect(10000, 1062300);
